...
public class ProductDAO implements IProductDAO {
    ...
    public List<Product> findAvailableProducts() {
        List<Product> list = new ArrayList<>();
        String sql = "select * from products where status = 'ACTIVE' and stock > 0 order by product_id";
    ...
    public List<Product> filterByCategory(int categoryId) {
        List<Product> list = new ArrayList<>();
        String sql = "select * from products where status = 'ACTIVE' and stock > 0 and category_id = ? order by product_id";
    ...
    public List<Product> filterByPrice(double minPrice, double maxPrice) {
        List<Product> list = new ArrayList<>();
        String sql = "select * from products where status = 'ACTIVE' and stock > 0 and price between ? and ? order by price asc";
